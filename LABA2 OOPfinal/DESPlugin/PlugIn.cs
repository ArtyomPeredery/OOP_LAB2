...
namespace DESPlugin
{
    ...
    {
        public string PluginName { get { return "aes"; } }
        public string PluginExtention { get { return ".aes"; } }
        public string PluginExtentionName { get { return ".aes |*.aes"; } }
        ...
        public void OpenFile(string inputFileName, string outputFileName)
        {
            ...
            byte[] result = Encoding.ASCII.GetBytes(FromAes256(bytes));
        ...
        public void SaveFile(string inputFileName)
        {
            ...
            byte[] bytes = File.ReadAllBytes(inputFileName);
            byte[] result = ToAes256(bytes.ToString());

            File.WriteAllBytes(OutputFileName, result);
            // File.Delete(inputFileName);
        }

        private static  byte[] arr = { 1, 0 };
